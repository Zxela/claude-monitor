...
export function stripInternalTags(text: string): string {
  ...
  s = s.replace(/^Caveat:\s*The messages below were generated by the user while running local commands\.?.*$/i, '');
